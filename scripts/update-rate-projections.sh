...
# Rule of thumb: pre-spread uninsured rate should be >= BoC + 1.5
# (nationally-advertised best rates). e.g. BoC 2.25% -> floor 3.75%.
# Catches garbage like 3.10% while passing legit 3yr rates (~3.89).
